...
public class BaseConvert
{
    public static void main (String[] args)
    {
        ...
        System.out.println("The maximum 4-digit number for base " + base +" is " +
                            maxNumber);
        int quotient;
        ...
        System.out.println("Your number in base " + base + " is written " +
                            "as " + baseBNum + place3 + place2 + place1 + place0);
    }
}